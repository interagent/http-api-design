...
This guide describes a set of RESTful HTTP+JSON API design practices,
originally extracted from work on the [Heroku Platform API](https://devcenter.heroku.com/articles/platform-api-reference).
...
We assume you’re familiar with the basics of HTTP, REST, and JSON and
in won’t cover all of the fundamentals of those in this guide.
...
individual resources, i.e. standard RESTful design. In cases where
special actions are needed, place them under a standard `actions`
